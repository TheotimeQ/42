...
{	
	...
	if (str[all_flag->index] == 'c')
		ft_putchar_fd(va_arg(arg, int), all_flag);
	else if (str[all_flag->index] == 's')
		ft_putstr_fd(va_arg(arg, char *), all_flag);
	else if (str[all_flag->index] == 'p')
		ft_put_un(va_arg(arg, unsigned long int), lhex, all_flag);
	else if (str[all_flag->index] == 'd' || str[all_flag->index] == 'i')
		ft_putnbr_fd(va_arg(arg, int), all_flag);
	else if (str[all_flag->index] == 'u')
		ft_putnbr_fd(va_arg(arg, unsigned int), all_flag);
	else if (str[all_flag->index] == 'x')
		ft_putnbr_base(va_arg(arg, unsigned int), lhex, all_flag);
	else if (str[all_flag->index] == 'X')
